...
(function (global, factory) {
    ...
    function restartBlink(cm) {
        ...
        if (cm.options.cursorBlinkRate > 0) {
            display.blinker = setInterval(function () { return display.cursorDiv.style.opacity = (on = !on) ? "" : "0"; },
                cm.options.cursorBlinkRate);
        }
        else if (cm.options.cursorBlinkRate < 0) { display.cursorDiv.style.opacity = "0"; }
    }
    ...
    TextareaInput.prototype.showSelection = function (drawn) {
        ...
        if (display.cursorDiv.firstChild == null || drawn.cursors.firstChild == null) {
            removeChildrenAndAdd(display.cursorDiv, drawn.cursors);
        }
        else {
            display.cursorDiv.firstChild.style.left = drawn.cursors.firstChild.style.left;
            display.cursorDiv.firstChild.style.top = drawn.cursors.firstChild.style.top;
        }
