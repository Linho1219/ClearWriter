...
(function (mod) {
  ...
  function dialogDiv(cm, template, bottom, confirm) {
    ...
    if (confirm) dialog.className += " CodeMirror-confirm";
  ...
  CodeMirror.defineExtension("openConfirm", function (
    ...
    closeNotification(this, null);
    var dialog = dialogDiv(this, template, options && options.bottom, true);
